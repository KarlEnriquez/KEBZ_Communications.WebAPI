...
namespace KEBZ_Communications.WebAPI.Migrations
{
    ...
    [Migration("20240411194644_configure-identity")]
            ...
            modelBuilder.Entity("Entities.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DeviceId = new Guid("476d2aec-70bf-4448-8ec1-613972c462ce"),
                        ...
                        new
                        {
                            DeviceId = new Guid("1ec995d9-944a-47ff-b1fe-b693ac858fce"),
                        ...
                        new
                        {
                            DeviceId = new Guid("d6026f25-a173-480e-bcc4-6893d081b842"),
                        ...
                        new
                        {
                            DeviceId = new Guid("e2f7f6c2-0c25-42f8-a633-705dd4d0b9c4"),
                        ...
                        new
                        {
                            DeviceId = new Guid("8af3df0f-921c-4062-ae7b-cd7952dec3ec"),
                        ...
                        new
                        {
                            DeviceId = new Guid("970f0d58-e553-4687-935e-748d9df7b06b"),
                        ...
                        new
                        {
                            DeviceId = new Guid("7ed5c860-a9fb-44dc-8f6e-10a15d03397b"),
            ...
            modelBuilder.Entity("Entities.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 11, 14, 46, 44, 734, DateTimeKind.Local).AddTicks(2630),
                            DataLimit = -1,
                            DeviceLimit = 2,
                            MinuteLimit = -1,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 11, 14, 46, 44, 734, DateTimeKind.Local).AddTicks(2640),
                            DataLimit = 10,
                            DeviceLimit = 2,
                            MinuteLimit = -1,
