...
namespace KEBZ_Communications.WebAPI.Migrations
{
    ...
    [Migration("20240419003226_undoaltdkey")]
    partial class undoaltdkey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DeviceId = new Guid("7885f9b5-ec97-4c01-942f-b539dd1db1e1"),
                        ...
                        new
                        {
                            DeviceId = new Guid("48981e87-7cf4-44dc-9762-218f218d93d3"),
                        ...
                        new
                        {
                            DeviceId = new Guid("4539cbcb-ece8-473f-9c57-45a37861c0b6"),
                        ...
                        new
                        {
                            DeviceId = new Guid("2d8178b1-0a6d-47ab-ac64-0db100ced2fb"),
                        ...
                        new
                        {
                            DeviceId = new Guid("d8c7d69d-f587-4ce0-9963-4779de590cca"),
                        ...
                        new
                        {
                            DeviceId = new Guid("bf1f5524-528e-4c5b-a543-9bdff355efca"),
                        ...
                        new
                        {
                            DeviceId = new Guid("c7b2e77a-154a-42a1-bf46-3addd7cba02c"),
            ...
            modelBuilder.Entity("Entities.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6790),
                            DataLimit = -1,
                            DeviceLimit = 2,
                            MinuteLimit = -1,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6800),
                            DataLimit = -1,
                            DeviceLimit = 2,
                            MinuteLimit = 1000,
            ...
            modelBuilder.Entity("Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4fe574cf-2f1f-41c7-aacb-b1d972dbfe5e",
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6630),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b52922f4-d052-49ea-b7bc-fee01d1e0be7",
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6670),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b35025f5-44cc-4c91-af20-5b4a2851ea8f",
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6680),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a5f6dee9-1ddc-4d90-8d3b-bed6c63933e4",
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6680),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d99f692f-6e6e-4ccc-b7c5-0c4ca86e96a6",
                            CreatedAt = new DateTime(2024, 4, 18, 19, 32, 26, 725, DateTimeKind.Local).AddTicks(6690),
